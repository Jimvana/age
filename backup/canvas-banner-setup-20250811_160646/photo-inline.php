...
<div class="age-estimator-photo-container age-estimator-photo-fullscreen canvas-banner-active <?php echo esc_attr($atts['class']); ?>" 
    ...
    <div class="age-estimator-fullscreen-notice" style="margin-top: 15px; padding: 12px; background: #e7f3ff; border: 1px solid #2196f3; border-radius: 4px; font-size: 14px; text-align: center;">
        <strong>🖥️ <?php _e('Fullscreen Mode:', 'age-estimator'); ?></strong> 
...
jQuery(document).ready(function($) {
    console.log('🖥️ Age Estimator: Fullscreen-only mode initialized');
